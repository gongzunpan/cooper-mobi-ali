...
#import "EndDateCell.h"

@implementation EndDateCell
...
- (void)initalizeInputView {
    ...
    //self.dateField.text = [Tools ShortNSDateToNSString:self.dateValue];
    //self.detailTextLabel.text = [Tools ShortNSDateToNSString:self.dateValue];
    
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, 200, 20)]; 
    [label setTextAlignment:UITextAlignmentLeft];
    label.text = [Tools ShortNSDateToNSString:self.dateValue]; 
